console.log('%cCopyright © 2024 houheya.us.kg', 'background-color: #ff00ff; color: white; font-size: 24px; font-weight: bold; padding: 10px;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function changeTheme(theme) {
        if (theme == "Dark") {
            ...
            document.documentElement.style.cursor = `url(pd.cur), auto`;
            htmlTag.dataset.theme = 'dack';
        } else if (theme == "Blue") {
            themeState = "Blue";
            changeSvg("#000000");
            tanChiShe.src = "/static/svg/snake-Light.svg";
            document.documentElement.style.cursor = `url(pl.cur), auto`;
